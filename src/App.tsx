      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-white">
            <div className="text-center px-4 max-w-4xl animate-fade-in mt-20 md:mt-0">
              ...
              <p className="text-base md:text-lg mb-8">
                ...
                exhausting, and emotionally draining. You love your child, but
                who takes care of YOU?
              </p>
              <button onClick={() =>
                  window.open("https://forms.gle/qNF5MjFC2nWGMUg59", "_blank")
                }
                 className="bg-[#F97100] font-happyMonkey  hover:bg-[#e66700] text-white px-4 py-2 md:px-8 md:py-4 rounded-full text-sm md:text-lg font-semibold transition-colors animate-scale-in">
        ...
        <div className="bg-green-50 py-16 reveal">
          <div className="max-w-screen-xl mx-auto flex flex-col-reverse md:flex-row gap-16 items-center justify-between">
            ...
            <div className="md:w-1/2 mt-8 md:mt-0 px-4 md:px-0">
              ...
              <p className="md-16 font-happyMonkey md:mt-20 text-sm md:text-lg font-semibold text-orange-500 italic text-center md:text-left">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-green-50 p-8 rounded-xl shadow-lg">
                ...
                <h3 className="text-2xl font-bold mb-4 font-happyMonkey">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg">
                ...
                <ul className="space-y-4 text-gray-700">
                  ...
                  <li className="flex items-start">
                    <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-1 mr-2" />
                    <span>
                      Develop a resilient mindset to handle challenges with
                      confidence
                    </span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-1 mr-2" />
                    <span>
                      Create a self-care routine that fits your busy life
                    </span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-1 mr-2" />
                    <span>
                      Find a supportive community that understands your journey
                    </span>
                  </li>
                  <li className="flex items-start">
                    <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-1 mr-2" />
                    <span>
                      Shift from just surviving to truly thriving as a special
                      needs parent
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg">
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span>
                      Continued stress, exhaustion, and emotional burnout
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-500 font-bold mr-2">❌</span>
                    <span>
                      Struggling with guilt, frustration, and feeling alone
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-500 font-bold mr-2">❌</span>
                    <span>
                      Lack of practical coping strategies for daily challenges
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-500 font-bold mr-2">❌</span>
                    <span>
                      Missing out on expert guidance and a support system
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-red-500 font-bold mr-2">❌</span>
                    <span>
                      Staying stuck in survival mode instead of thriving
                    </span>
                  </li>
                </ul>
                <p className="mt-6 text-lg font-semibold text-[#F97100]">
                  Don’t wait until burnout takes over—take this step towards
        ...
        <div className="py-20 bg-white reveal">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  Founder of the Diary of a Special Needs Mum Initiative under
                  the P4:13 Foundation, Bukola Ayinde is a passionate advocate
                  for disability inclusion and special needs parenting.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Special Needs Therapist, NLP Practitioner, and Trauma
                        Care Coach
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Six books on disability awareness including a 30 day
                        journal of her experience as a special needs mum titled,
                ...
                <div className="bg-green-50 p-6 rounded-xl">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li>
                      • Founder of D.P.I Services and Diary of a Special Needs
                      Mum Initiative
                    </li>
                    <li>
            ...
            <div className="mt-16">
              <h3 className="text-3xl font-happyMonkey font-bold text-center mb-10 text-gray-800">
                Notable Achievements
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white p-6 rounded-xl shadow-lg border border-green-100">
                  <h4 className="font-semibold text-[#F97100] mb-3 font-happyMonkey">
                    Breaking Barriers Project
                  </h4>
                  <p className="text-gray-700">
                    Founded the Breaking Barriers: Disability Inclusion Through
                    Book Reading project, reaching over 500 students across
                    Lagos and Abuja.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-lg border border-green-100">
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg border border-green-100">
                  ...
                  <p className="text-gray-700">
                    Active member of the Gender and Disability Inclusion Team
                    and advocate for inclusive education through various
                    platforms.
                  </p>
                </div>
              </div>
        ...
        <section className="py-16 bg-gray-100 text-center">
          <div className="max-w-screen-xl mx-auto">
            <h2 className="text-3xl font-happyMonkey font-bold text-green-700 mb-8">
        ...
        <div className="bg-[#F97100] py-16 text-white reveal">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-happyMonkey font-bold text-center mb-12">
              Event Details
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                <Calendar className="w-12 h-12 mx-auto mb-4" />
                <h3 className="text-xl font-bold mb-2 font-happyMonkey">
                  Date
                </h3>
        ...
        <div className="bg-gray-900 text-white py-12 reveal">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto">
              <h2 className="text-3xl font-bold font-happyMonkey mb-8">
                Get in Touch
              </h2>
              <div className="flex flex-col gap-y-6 sm:flex-row items-center justify-center space-x-8 mb-6">
                ...
                <div className="flex items-center">
                  ...
                  <a href="https://wa.me/+2347046468669 ">
                    0704 646 8669 (WhatsApp msg only)
                  </a>
                </div>
              </div>
              <button
                className="bg-[#F97100] font-happyMonkey hover:bg-[#e66700] text-white px-8 py-4 rounded-full text-lg font-semibold transition-colors"
                onClick={() =>
                  window.open("https://forms.gle/qNF5MjFC2nWGMUg59", "_blank")
                }
              >
              ...
              <p className="mt-8 font-happyMonkey text-lg">
